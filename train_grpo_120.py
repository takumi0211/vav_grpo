...
RESUME_CKPT = os.path.join(OUT, "checkpoint-120")
DATA_DIR = "data"
...
stream = StepStream(
    ...
    extra_keys=("state_json", "state_json_normalize", "sample_id", "selected_action", "q1"),
)
...
# checkpoint-120 から再開（optimizer/scheduler state も復元）
